...
// build-gradle에 implementation 'org.springframework.boot:spring-boot-starter-validation' 넣기기
...
public class Validation {
    ...
    // @NotEmpty : '문자열'에서 null과 빈문자열을 허용하지 않음
    @NotEmpty
    private String notEmpty;

    // @NotBlank : '문자열'에서 null과 빈문자열 혹은 공백문자열 허용하지 않음
    @NotBlank
    private String notBlank;

    //! 주의 : NotBlank와 NotEmpty를 문자열이 아닌 타입에서 사용하지 않도록 해야 함
    // @NotBlank
    // private Integer intNotBlaknk;
