...
// - filter에서 걸러진 Request는 서블릿까지 도달하지 못하고 중간에서 reject 됨
...
public class JwtAuthenticationFilter extends OncePerRequestFilter{
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
            ...
            try {
                    ...
                    AbstractAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(subject, null ,roles); // 2개만 넣으면 roles가 비번이 되서 null을 넣어둠
    ...
    // 1. request 객체 header에서 'Autorization' 필드의 값을 가져옴
    ...
    // 3. Authorization 필드 값에서 토큰만 추출
    // Bearer asdafgwevssdjkvhbnsajkdbhasijkcaojdhuasdjn...
